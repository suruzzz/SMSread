...
public class Pushdata extends AsyncTask<String, Void, String> {
    ...
    public AsynkResponse delegate = null;

    public Pushdata(AsynkResponse asyncResponse) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try{
            ...
            URL url = new URL("https://script.google.com/macros/s/AKfycbx2rXA3-3QJbCSpjxCplp_JzHj94S3YRFteP4YlKCKlJ11oXWM/exec");
            JSONObject postDataParams = new JSONObject();
            String id= "1zWGugaekSDwLzub9vCrG47Dwjn7hUJoCPU33oHvQqQs";
